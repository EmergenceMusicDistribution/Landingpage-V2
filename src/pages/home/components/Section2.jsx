...
export const Section2 = () => {
  return (
    <div style={{background:'linear-gradient(90deg, #231517, #121213 49%, #1e1925)'}} className='bg-[#1e1f26] sm:px-3 text-white space-y-7 py-10'>

     <h2 className='text-4xl sm:text-3xl text-center capitalize font-bold '> <span className=' uppercase text-teal-400'>INFINITE</span> Digital Music Streaming Platforms Worldwide</h2>   
    ...
    <div className='flex items-center w-1/2 sm:w-full md:w-full m-auto sm:px-0 md:px-5 justify-center flex-wrap gap-4'>
